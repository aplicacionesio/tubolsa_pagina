(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                {
                    path: 'buscar',
                    loadChildren: function () { return Promise.all(/*! import() | modules-buscar-buscar-module */ [__webpack_require__.e("common"), __webpack_require__.e("modules-buscar-buscar-module")]).then(__webpack_require__.bind(null, /*! ./modules/buscar/buscar.module */ "./src/app/modules/buscar/buscar.module.ts")).then(function (modulo) { return modulo.BuscarModule; }); }
                },
                {
                    path: 'portada',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | modules-portada-portada-module */ "modules-portada-portada-module").then(__webpack_require__.bind(null, /*! ./modules/portada/portada.module */ "./src/app/modules/portada/portada.module.ts")).then(function (modulo) { return modulo.PortadaModule; }); }
                },
                {
                    path: 'registros',
                    loadChildren: function () { return Promise.all(/*! import() | modules-registros-registros-module */ [__webpack_require__.e("common"), __webpack_require__.e("modules-registros-registros-module")]).then(__webpack_require__.bind(null, /*! ./modules/registros/registros.module */ "./src/app/modules/registros/registros.module.ts")).then(function (modulo) { return modulo.RegistrosModule; }); }
                },
                {
                    path: 'favoritos',
                    loadChildren: function () { return Promise.all(/*! import() | modules-favoritos-favoritos-module */ [__webpack_require__.e("common"), __webpack_require__.e("modules-favoritos-favoritos-module")]).then(__webpack_require__.bind(null, /*! ./modules/favoritos/favoritos.module */ "./src/app/modules/favoritos/favoritos.module.ts")).then(function (modulo) { return modulo.FavoritosModule; }); }
                },
                {
                    path: 'ficha/:id',
                    loadChildren: function () { return Promise.all(/*! import() | modules-ficha-ficha-module */ [__webpack_require__.e("common"), __webpack_require__.e("modules-ficha-ficha-module")]).then(__webpack_require__.bind(null, /*! ./modules/ficha/ficha.module */ "./src/app/modules/ficha/ficha.module.ts")).then(function (modulo) { return modulo.FichaModule; }); }
                },
                {
                    path: 'sesion-iniciar',
                    loadChildren: function () { return __webpack_require__.e(/*! import() | modules-usuarios-sesion-iniciar-sesion-iniciar-module */ "modules-usuarios-sesion-iniciar-sesion-iniciar-module").then(__webpack_require__.bind(null, /*! ./modules/usuarios/sesion-iniciar/sesion-iniciar.module */ "./src/app/modules/usuarios/sesion-iniciar/sesion-iniciar.module.ts")).then(function (modulo) { return modulo.SesionIniciarModule; }); }
                },
                {
                    path: '',
                    loadChildren: function () { return Promise.all(/*! import() | modules-buscar-buscar-module */ [__webpack_require__.e("common"), __webpack_require__.e("modules-buscar-buscar-module")]).then(__webpack_require__.bind(null, /*! ./modules/buscar/buscar.module */ "./src/app/modules/buscar/buscar.module.ts")).then(function (modulo) { return modulo.BuscarModule; }); }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SidenavComponent = /** @class */ (function () {
                function SidenavComponent(autorizacion, _sidenavServiceService) {
                    var _this = this;
                    this.autorizacion = autorizacion;
                    this._sidenavServiceService = _sidenavServiceService;
                    // Cargar usuario actual si está logeado
                    this.autorizacion.gioUsuario.subscribe(function (data) {
                        _this.usuario = data;
                ...
                SidenavComponent.prototype.sideNavCerrar = function () {
                ...
                SidenavComponent.prototype.iniciarSesionFacebook = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                function ToolbarComponent(autorizacion, 
                ...
                ToolbarComponent.prototype.regresar = function () {
                    this._location.back();
                };
                ToolbarComponent.prototype.sidenavToggle = function () {
                    console.log("Algo");
                    this._sidenavServiceService.open();
                    // this._sidenavServiceService.toggle()
                };
                ToolbarComponent.prototype.llamarFavoritos = function () {
                    var uid = this.autorizacion.traerUidSiExisteUsuario();
                    if (uid == null) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FirebaseAuthService = /** @class */ (function () {
                function FirebaseAuthService(autorizacion) {
                    this.autorizacion = autorizacion;
                    this.gioUsuario = this.autorizacion.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (authState) {
                        if (authState) {
                            return authState;
                        }
                        else {
                ...
                FirebaseAuthService.prototype.crearUsuarioAnonimo = function () {
                    this.autorizacion.auth.signInAnonymously().then(function (usuario) {
                        console.log("Sesión anónima creada", usuario);
                    }).catch(function (error) {
                        console.log("Error en la sesión anónima", error);
                    });
                };
                FirebaseAuthService.prototype.crearUsuarioConEmail = function (data) {
                    var email = data.email;
                    var password = data.password;
                    var displayName = data.displayName;
                    this.autorizacion.auth.createUserWithEmailAndPassword(email, password).then(function (usuario) {
                        usuario.user.updateProfile({
                            displayName: displayName
                        });
                    });
                };
                FirebaseAuthService.prototype.cerrarSesion = function () {
                    this.autorizacion.auth.signOut();
                };
                FirebaseAuthService.prototype.traerUidSiExisteUsuario = function () {
