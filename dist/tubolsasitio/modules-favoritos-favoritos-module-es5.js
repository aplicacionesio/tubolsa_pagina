(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-favoritos-favoritos-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FavoritosComponent = /** @class */ (function () {
                function FavoritosComponent(autorizacion, _noderestapiService, dialog) {
                    var _this = this;
                    ...
                    this.autorizacion.autorizacion.authState.subscribe(function (response) {
                        if (response == null) {
                            console.log("No hay sesión para obtener uid");
                        }
                        else {
                            _this.mostrarFavoritos(response.uid);
                        }
                    });
                }
                FavoritosComponent.prototype.mostrarFavoritos = function (uid) {
                    var _this = this;
                    this._noderestapiService.traerFavoritos(uid).subscribe(function (response) {
                        _this.departamentos = response['data'];
                        for (var index = 0; index < _this.departamentos.length; index++) {
                            // console.log( JSON.parse(this.departamentos[index]['departamento']) )
                            _this.departamentos[index]['departamento'] = JSON.parse(_this.departamentos[index]['departamento']);
                        }
            ...
            FavoritosComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FavoritosModule = /** @class */ (function () {
                function FavoritosModule() {
                }
                return FavoritosModule;
            }());
...
//# sourceMappingURL=modules-favoritos-favoritos-module-es5.js.map
//# sourceMappingURL=modules-favoritos-favoritos-module-es5.js.map