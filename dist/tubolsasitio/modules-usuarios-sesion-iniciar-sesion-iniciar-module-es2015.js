...
let ComponenteAlertasComponent = class ComponenteAlertasComponent {
...
ComponenteAlertasComponent.ctorParameters = () => [
...
let ComponenteAlertasModule = class ComponenteAlertasModule {
};
...
let SesionIniciarComponent = class SesionIniciarComponent {
    /**
     * Constructor
     *
     * @param {FormBuilder} _formBuilder
     */
    constructor(_formBuilder, autorizacion, dialog, router, paginaActual) {
    ...
    iniciarSesion() {
        ...
        this.autorizacion.autorizacion.auth.signInWithEmailAndPassword(email, password).then(event => {
            ...
            const dialogoMapa = this.dialog.open(_componentes_componente_alertas_componente_alertas_component__WEBPACK_IMPORTED_MODULE_7__["ComponenteAlertasComponent"], this.configuracionDialogo);
        });
    }
    iniciarSesionFacebook() {
        let provider = new firebase__WEBPACK_IMPORTED_MODULE_9__["auth"].FacebookAuthProvider;
    ...
    olvidePassword() {
        ...
        const alertaGenerada = this.dialog.open(_componentes_componente_alertas_componente_alertas_component__WEBPACK_IMPORTED_MODULE_7__["ComponenteAlertasComponent"], this.configuracionDialogo);
        alertaGenerada.afterClosed().subscribe(result => {
            this.autorizacion.autorizacion.auth.sendPasswordResetEmail(result).then(data => {
                ...
                this.dialog.open(_componentes_componente_alertas_componente_alertas_component__WEBPACK_IMPORTED_MODULE_7__["ComponenteAlertasComponent"], this.configuracionDialogo);
            }).catch(error => {
                switch (error.code) {
                    case "auth/invalid-email":
...
SesionIniciarComponent.ctorParameters = () => [
...
let SesionIniciarModule = class SesionIniciarModule {
};
...
let PaginaActualService = class PaginaActualService {
    constructor(router) {
        this.router = router;
        this.paginaActual = "/";
    }
...
PaginaActualService.ctorParameters = () => [
